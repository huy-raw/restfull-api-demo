...
public class UserService {
    ...
    public void deleteUserById(@NotNull String id) {
        ...
        try {
            if (userOptional.isPresent()) {
                log.error("User is have id " + id + " existed");
                throw new IllegalStateException("User is have id " + id + " existed");
            }
    ...
    public UserDTO findUserById(@NotNull String id) {
        UserDTO user = userMapper.INSTANCE.toUserDTO(userRepository.findById(id).orElseThrow(() -> {
    ...
    public UserDTO findUserByEmail(@NotNull @Email String email) {
        UserDTO user = userMapper.INSTANCE.toUserDTO(userRepository.findUserByEmail(email));
        if(user == null){
    ...
    public UserDTO updateUser(@NotNull  String id, UpdateUserRequest req){
